 ...
 * @access public
-------------------------------------*/
export const sendResetPasswordLinkCtrl = asyncHandler(async (req: Request, res: Response) => {
 ...
 * @access public
---------------------------------------*/
export const getResetPasswordLinkCtrl = asyncHandler(async (req: Request, res: Response) => {
